...
If you want to see how little tail is left, look at what surfaced in the last few days: [OpenAI accused China-linked accounts](https://www.aljazeera.com/economy/2026/6/11/openai-says-china-based-actors-stoking-opposition-to-ai-data-centres) of using ChatGPT *itself* to generate astroturf content opposing US AI data centres. The platform is being used to manufacture public opinion about the platform. The thing we were worried might happen eventually is happening now, in the present tense, before the ad model has even fully matured.

## Meanwhile, the consumer revolt is already underway

Here's the genuinely hopeful part, and it's happening in exactly the place you might expect: gaming.

Independent of GPU prices, gamers are fed up. The big studios have consolidated, and the products are driven by profit rather than craft. Consumers are turning, in droves, to indie and AA studios, to European and Japanese houses. They don't want live-service games. They didn't appreciate being told — [by Ubisoft](https://www.ign.com/articles/ubisoft-exec-says-gamers-need-to-get-comfortable-not-owning-their-games-for-subscriptions-to-take-off), in a line everyone understandably but incorrectly attributes to EA — that they need to "get comfortable" not owning their games. Then Ubisoft proved the point by switching off *The Crew*, a game people had *paid for*, and that act of corporate vandalism catalysed the [Stop Killing Games](https://en.wikipedia.org/wiki/Stop_Killing_Games) movement, which has since gathered over 1.4 million validated signatures in the EU and spun up [formal NGOs on two continents](https://www.notebookcheck.net/Stop-Killing-Games-launches-EU-and-US-watchdog-NGOs-as-Ross-Scott-says-I-think-we-re-going-to-win-this.1235433.0.html).

People are also sick of 100GB downloads for games that don't even work. They're sick of the abandonment of optimisation; not because developers can't optimise, but because the corporate engine behind them doesn't value the hours it takes. Retro gaming is having a renaissance, partly because the games actually load instantly and demonstrate real creativity, and partly because ten-year-old games still hold as the advances since are locked behind hardware most people can't afford and can barely perceive.

AI consumers are having the *same reaction.* LLMs are marvels, but they are nowhere near optimised. Chinese labs are already shipping models that run well on modest, even consumer, hardware. There's open work on more efficient GPU designs — narrowing the distance between compute and memory — paired with software that does more with less. Gamers are demanding efficiency. AI users are demanding the same thing.

And it mirrors everything else: right-to-repair, the rise of self-hosting, the cyberdeck subculture, the don't-kill-games campaign. The common thread is consumers who've simply had enough.
...
Intel is quietly shipping what are becoming the best value-for-money cards on the market. The [Arc Pro B70](https://videocardz.com/newz/intel-launches-arc-pro-b70-at-949-with-32gb-gddr6-memory) launched in March 2026: 32GB of GDDR6 with an MSRP of $949 USD (under $1,500 AUD, and while they tend to retail for closer to $2,000 AUD, that's still less than half the NVIDIA equivalent in terms of VRAM) — explicitly aimed at local LLM inference, pitched on tokens-per-dollar against NVIDIA's workstation cards. They have the same ecosystem problem AMD once had, but two things are different: they're actually doing something about it, and market forces are finally on their side. Tellingly, Intel has reportedly [killed discrete *gaming* GPUs for its next architecture entirely](https://www.tomshardware.com/pc-components/gpus/intels-arc-pro-b70-workstation-gpu-with-32gb-of-vram-gets-tested-in-games-roughly-twice-as-fast-as-arc-b580-on-average-beats-rtx-5060-ti-in-some-titles). They, too, have read the room.

With NVIDIA and Intel both walking away from the consumer gaming GPU, that leaves AMD. And the tragedy is that three or four years ago the average consumer would have *loved* to jump from team green to team red, but AMD didn't invest in the ecosystem and their products never reached their full potential. AMD could have eaten NVIDIA's lunch, but instead they squandered the goodwill that they had. They still have more of that than NVIDIA, but less *confidence*, which is not the same thing.

But GPUs aren't the whole story. Intel's CPUs aren't the exclusive kings they once were. AMD has outlasted every Intel challenger (remember Cyrix? dear god) and has genuinely competed on performance for a long time, but the old reliability reputation lingers unfairly. There's pressure from ARM: Apple's M-series started it, now Snapdragon PCs continue it. Intel's lead is gone, probably forever. **And yet Intel's CPU prices have not come down.** Will the RTX Spark also be expensive? Yes. Less than an RTX GPU, but still expensive.

That's the game. It's musical chairs, and the house always wins — the house being the corporate tech industry as a whole, passing the consumer between products while the price floor only ever ratchets up.

## The sovereignty angle (and why this matters more here)

There's a dimension to local-first AI that the pure consumerism framing misses, and it's the one I keep coming back to. Personal AI on personal silicon isn't only a value play. It's the *only* path that doesn't route your thinking through someone else's ad-supported, jurisdiction-bound, politically-shapeable inference layer.

The CLOUD Act reaches a model running in OpenAI's data centre. It does not reach a model running on the laptop in front of you. For anyone outside the United States, and especially for those of us watching [US tech policy lurch toward economic nationalism](https://www.beerdriven.dev/episodes/70/), 'the AI you actually control' stops being a hobbyist's preference and starts being the only sane default. The RTX Spark, the Arc Pro B70, the whole local-inference turn - frame it as sovereignty and it reads very differently to an Australian audience than it does to Silicon Valley.

## Prices won't fall. We'll demand longevity instead.

I don't think we're going back to pre-Bitcoin consumer hardware pricing. Ever. But I do think we're going back to *longer tails on investment*. And maybe that's fine. We should remember that computers used to be obscenely expensive. It's the cheap years that were the anomaly; this is just a renormalisation.

But renormalisation comes with a demand attached. The reflexive consumer-capitalist churn that defined tech — new phone every year, new GPU every cycle — is dying. People will still spend the money, they just won't spend it *every year*. They'll expect a computer to last five or ten years, and, crucially, they'll expect developers to keep catering to it. That's what all those movements I mentioned are really about: when an unstoppable force meets an immovable object, you get a compromise. We'll buy the absurdly expensive hardware. But we'll demand the right to repair it, and the right to make it last. I also suspect gamers will find a way of wringing better performance out of inference cards, just like LLM tinkerers do with gaming cards.

## Who actually loses

On the tech-titan side, the only real long-term loser, I think, is OpenAI. Not dead (yet), but cornered, deserted by its two great patrons, holding compute commitments it can't pay against a consumer market that's discovering it never needed to rent what it can eventually own.
...
Here's the thing I haven't seen anyone say, and the reason I wanted to write this at all.
