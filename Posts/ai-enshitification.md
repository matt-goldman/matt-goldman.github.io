...
With NVIDIA and Intel both walking away from the consumer gaming GPU, that leaves AMD. And the tragedy is that three or four years ago the many gamers would have loved to jump from team green to team red, but AMD didn't invest in the ecosystem and their products never reached their full potential. AMD could have eaten NVIDIA's lunch, but instead they squandered the goodwill that they had. They still have more of that than NVIDIA (an admittedly low bar), but less *confidence*, which is not the same thing.
...
Which leads to the question almost nobody is asking, at least about AI. If the enterprise windfall isn't coming, but the technology is real, ubiquitous, and expensive, who pays, and how? And we have the answer, twice over.
